...
contract PreSaleMetric is Ownable {
    ...
    uint256 public constant tgeAmount = 6e6 * 1e18;
    uint256 public remainingAmount = totalAllocation - tgeAmount;
    uint256 public eachReleaseAmount = (totalAllocation * 2) / 100;
    uint256 public nextTimeRelease = now + 30 days;
    uint256 public releasePeriod = 1 weeks;
    uint256 public lastTimeRelease = now + 30 days + 40 weeks;
