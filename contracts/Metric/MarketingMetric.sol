...
contract MarketingMetric is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IERC20 public token;

    uint256 public constant totalAllocation = 30e6 * 1e18;
    uint256 public constant tgeAmount = 0;
    uint256 public remainingAmount = totalAllocation - tgeAmount;
    uint256 public firstTimeReleaseAmount = (totalAllocation * 15) / 100;
    uint256 public eachReleaseAmount = (totalAllocation * 5) / 100;
    uint256 public nextTimeRelease = now + 1 weeks;
    uint256 public releasePeriod = 30 days;
    uint256 public lastTimeRelease = now + 517 days;
