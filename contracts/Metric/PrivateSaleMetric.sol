...
contract PrivateSaleMetric is Ownable {
    ...
    uint256 public constant tgeAmount = 15e5 * 1e18;
    uint256 public remainingAmount = totalAllocation - tgeAmount;
    uint256 public eachReleaseAmount = (totalAllocation * 17) / 1000;
    uint256 public nextTimeRelease = now + 30 days;
    uint256 public releasePeriod = 1 weeks;
    uint256 public lastTimeRelease = now + 30 days + 50 weeks;
